...
/// Writes a camera model to a JSON file.
///
/// # Arguments
///
/// * `output_path` - The path to the output JSON file.
/// * `camera_model` - The camera model instance to serialize.
...
/// Reads a camera model from a JSON file.
///
/// # Arguments
///
...
/// # Returns
///
/// A `GenericModel` instance deserialized from the JSON file.
